...
class MWImgObs(gym.Wrapper):
    def __init__(self, env, cam_height=84, cam_width=84, depth=True, cam_name='corner'):
        self.env = env
        super().__init__(env)
        self._res = (cam_height, cam_width)
        self._camera_name = cam_name
        self._depth = depth
        render_context = mujoco_py.MjRenderContextOffscreen(self.env.sim, device_id=0)
    ...
    def _render(self, depth=False):
        ...
        if self._camera_name is not None:
            vis_obs = self.env.sim.render(*self._res, mode='offscreen', camera_name=self._camera_name, depth=depth, device_id=0)
...
def wrap_mw_env(env, train_tasks, goal_cost_reward: bool, stop_at_goal: bool = False, steps_at_goal: int = 1, cam_height=84, cam_width=84, depth=True, cam_name=None, fix_task_sequence=False):
    ...
    env = MWImgObs(env, cam_height, cam_width, depth, cam_name)
...
class Benchmark(abc.ABC):
    ...
    def create_train_env(self, task_name, goal_cost_reward=False, stop_at_goal= False, steps_at_goal=1, cam_height=84, cam_width=84, depth=True, cam_name='corner', fix_task_sequence=False):
        return wrap_mw_env(self.train_classes[task_name](), self.train_tasks, goal_cost_reward, stop_at_goal, steps_at_goal, cam_height, cam_width, depth, cam_name, fix_task_sequence)

    def create_test_env(self, task_name, goal_cost_reward=False, stop_at_goal= False, steps_at_goal=1, cam_height=84, cam_width=84, depth=True, cam_name='corner', fix_task_sequence=False):
        return wrap_mw_env(self.test_classes[task_name](), self.test_tasks, goal_cost_reward, stop_at_goal, steps_at_goal, cam_height, cam_width, depth, cam_name, fix_task_sequence)
...
def mw_gym_make(task_name, goal_cost_reward=False, stop_at_goal=False, steps_at_goal=1, cam_height=84, cam_width=84, depth=True, cam_name='corner', train_distrib=True, fix_task_sequence=False):
